...
namespace BusinessIntelligence_API.Controllers
{
    [Route("api/")]
    [ApiController]
    public class BiFinCusDefSheetsController : BaseController
    {

        private readonly IBiFinCusDefSheetRepository _repository;
        private readonly Models.JTSContext _jtscontext;
        public BiFinCusDefSheetsController(Models.JTSContext jTSContext, IBiFinCusDefSheetRepository repository, IHttpContextAccessor httpContextAccessor)
        {
        ...
        [HttpPost("findata/insert")]
        [Authorize(Roles = "User")]
        public async Task<IActionResult> Create([FromBody] BiFinCusDefSheet item)
        {
            try
            {
        ...
        [HttpGet("findata/displaybyid/{id}")]
        [Authorize(Roles = "User")]
        ...
        [HttpPut("findata/update")]
        [Authorize(Roles = "User")]
        public async Task<IActionResult> Update(BiFinCusDefSheet item)
        {
            try
            {
        ...
        [HttpDelete("finData/deletebyid/{id}")]
        [Authorize(Roles = "User")]
