...
namespace BusinessIntelligence_API.Controllers
{
    ...
    public class DepartmentMasterController : BaseController
    {
        ...
        public DepartmentMasterController(IDepartmentRepository repository, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IActionResult> Create([FromBody] BiDepartmentMst item)
               {
            try
            {
        ...
        [HttpGet("department/displaybyid/{id}")]
        [Authorize(Roles = "User")]
        ...
        [Authorize(Roles = "User")]
        public async Task<IActionResult> Update(BiDepartmentMst item)
        {
            try
            {
        ...
        [HttpDelete("department/deletebyid/{id}")]
        [Authorize(Roles = "User")]
